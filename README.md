...
This is developed on multiple different \*NIX platform.  If it doesn't work on whatever it is you're using, please open a github issue with details.  If you know how to fix it, please submit a PR. Thank you!
